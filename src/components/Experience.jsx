...
Naukri, 99acres, and Shiksha, identifying bugs and validating system workflows to ensure reliability and performance.</p>
          ...
          <div className="timeline-item">
            ...
            <p>Developed key frontend features for Moodboard and Leaderbaord using React, CSS, and Tailwind. Developed the main products whole forntend. Reduced load times by 15% and enhanced UX on complex components.</p>
          </div>
  
          <div className="timeline-item">
            <h4>UI/UX Member – Linux Club VIT</h4>
            <p><strong>Aug 2024 – Jul 2025</strong></p>
            <p>Supported frontend development and event-based marketing efforts. Helped in crafting designs and interfaces using Figma and code.</p>
          </div>
  
          <div className="timeline-item">
            <h4>Marketing Member – QUBIT TECHNO VIT</h4>
            <p><strong>Aug 2023 – Oct 2023</strong></p>
            <p>Contributed to event promotion and community engagement, increasing visibility and student participation.</p>
          </div>
        </div>
      </section>
    );
